...
<div class="flex-1 px-4 flex justify-between items-center">
    ...
    <div class="ml-4 flex items-center md:ml-6">
        ...
        <div class="ml-3 relative">
            <div>
                <button type="button" @click="open = !open" class="max-w-xs flex items-center text-sm rounded-full focus:outline-none focus:shadow-outline" id="user-menu" aria-label="User menu" aria-haspopup="true">
